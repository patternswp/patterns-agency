...
<div class="wp-block-group alignfull has-secondary-background-color has-background" style="padding-top:80px;padding-right:var(--wp--preset--spacing--40);padding-bottom:80px;padding-left:var(--wp--preset--spacing--40)">

<!-- wp:pattern {"slug":"patterns-agency/section-title-2"} /-->

<!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"left":"80px"},"padding":{"top":"60px"}}}} -->
<div class="wp-block-columns alignwide" style="padding-top:60px"><!-- wp:column {"verticalAlignment":"top","width":"33.33%","style":{"shadow":"var:preset|shadow|natural"}} -->
...
<div class="wp-block-column is-vertically-aligned-top" style="box-shadow:var(--wp--preset--shadow--natural);flex-basis:33.33%"><!-- wp:group {"style":{"border":{"radius":"5px"},"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"},"blockGap":"20px"},"dimensions":{"minHeight":""},"layout":{"selfStretch":"fixed","flexSize":"300px"}},"backgroundColor":"default","className":"at-box-sdw pa-box-sdw","layout":{"type":"constrained"}} -->
<div class="wp-block-group at-box-sdw pa-box-sdw has-default-background-color has-background" style="border-radius:5px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:group {"style":{"dimensions":{"minHeight":""},"layout":{"selfStretch":"fit","flexSize":""},"color":{"background":"#e3e9fa"},"border":{"radius":"5px"},"spacing":{"margin":{"bottom":"30px"}}},"className":"at-m patterns-agency-is-h-w-80 at-h at-w  at-flx at-al-itm-ctr at-jfy-cont-ctr pw-icon-t","layout":{"type":"default"}} -->
<div class="wp-block-group at-m patterns-agency-is-h-w-80 at-h at-w at-flx at-al-itm-ctr at-jfy-cont-ctr pw-icon-t has-background" style="border-radius:5px;background-color:#e3e9fa;margin-bottom:30px"><!-- wp:html -->
