...
/**
 * Title: Page Sitemap
 * Slug: patterns-agency/page-sitemap
 * Post Types: page
...
<div class="wp-block-columns alignwide" style="padding-top:80px;padding-bottom:80px">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Pages', 'patterns-agency' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Categories', 'patterns-agency' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Posts', 'patterns-agency' ); ?></h4>
			<!-- /wp:heading -->
			...
			<div class="wp-block-query alignfull">
				...
				<div class="wp-block-group" style="margin-top: 0; margin-bottom: 0; padding-top: var(--wp--preset--spacing--60); padding-right: 0; padding-bottom: var(--wp--preset--spacing--40); padding-left: 0">
					<!-- wp:pattern {"slug":"patterns-agency/pagination"} /-->
					<?php
