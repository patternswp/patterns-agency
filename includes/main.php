...
class Patterns_Agency {
	...
	private function load_dependencies() {
		...
		require_once PATTERNS_AGENCY_PATH . 'includes/functions.php';

		/**The class responsible for defining all actions that occur in both admin and public area.*/
		require_once PATTERNS_AGENCY_PATH . 'includes/class-include.php';

		/**The class responsible for block bindings.*/
		require_once PATTERNS_AGENCY_PATH . 'includes/class-block-bindings.php';

		/* API */
		require_once PATTERNS_AGENCY_PATH . 'includes/api/index.php';

		/**The class responsible for defining all actions that occur in the admin area.*/
		require_once PATTERNS_AGENCY_PATH . 'admin/index.php';

		/** The class responsible for defining all actions that occur in the public-facing side of the site.*/
		require_once PATTERNS_AGENCY_PATH . 'public/index.php';
	}
}
